...
ActiveRecord::Schema.define(version: 20260925090000) do
  ...
  create_table "abilities", force: :cascade do |t|
    ...
    t.boolean "admin_assignable", default: false, null: false
  ...
  create_table "client_requests", force: :cascade do |t|
    ...
    t.text "reason"
    t.integer "purchase_check_status", default: 0, null: false
    t.date "sold_at"
  ...
  create_table "device_tasks_repair_causes", id: false, force: :cascade do |t|
  ...
  create_table "duty_schedule_color_settings", force: :cascade do |t|
    t.string "key", null: false
    t.string "color", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["key"], name: "index_duty_schedule_color_settings_on_key", unique: true
  end
  ...
  create_table "iphone_sales_imports", force: :cascade do |t|
    t.string "delivery_id", null: false
    t.date "period_from", null: false
    t.date "period_to", null: false
    t.datetime "calculated_at", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["delivery_id"], name: "index_iphone_sales_imports_on_delivery_id", unique: true
    t.index ["status", "calculated_at"], name: "index_iphone_sales_imports_on_status_and_calculated_at"
  end
  ...
  create_table "locations", id: :serial, force: :cascade do |t|
    ...
    t.index ["for_testing"], name: "index_locations_on_for_testing"
  ...
  create_table "marker_words", force: :cascade do |t|
  ...
  create_table "product_groups", id: :serial, force: :cascade do |t|
    ...
    t.index ["repair_group_id"], name: "index_product_groups_on_repair_group_id"
  end
  ...
  create_table "schedule_groups", force: :cascade do |t|
    t.string "name", null: false
    t.bigint "city_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "design_settings", default: {}, null: false
    t.index ["city_id"], name: "index_schedule_groups_on_city_id"
  ...
  create_table "schedule_week_snapshots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["schedule_group_id", "week_start"], name: "idx_snapshots_group_week", unique: true
    t.index ["schedule_group_id"], name: "index_schedule_week_snapshots_on_schedule_group_id"
  end
  ...
  create_table "testing_templates", force: :cascade do |t|
    t.text "content", null: false
    t.integer "position", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
