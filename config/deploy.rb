...
set :branch, ENV.fetch('DEPLOY_REF', ENV.fetch('BRANCH', 'master'))
...
append :linked_files, 'config/database.yml', 'config/schedule.yml', '.env', 'config/weekly_markup_import_token'
