...
class NotificationDispatcher
  ...
  # Повод, о котором уже уведомляли: вторую запись в колокольчике не создаём,
  # а переброадкастим существующую — иконка снова привлекает внимание.
  # Доставку в Telegram это не отменяет: следа об отправке не остаётся, и
  # пропустив её, мы рискуем оставить сотрудника без сообщения вовсе, если
  # предыдущий прогон оборвался до отправки.
