class ServiceJobPolicy < CommonPolicy
  ...
  # «Забрать устройство у другого технического специалиста» — тот же круг, что и
  # управление статусом ремонта: перехват создаёт новую in_progress-запись под текущим
  # юзером, а не какое-то привилегированное действие.
  def seize_repair?
    update_repair_status?
  end
