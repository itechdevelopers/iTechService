...
class ServiceJobsController < ApplicationController
  ...
  def service_job_params
    params.require(:service_job).permit(
      ...
      data_storages: [],
      device_tasks_attributes: [:id, :_destroy, :task_id, :cost, :comment, :user_comment, :performer_id, :expected_repair_cause_id, :expected_repair_service_id, expected_repair_cause_ids: []],
