...
describe SalesController do
  ...
  # SoldDevice. As you add validations to SoldDevice, be sure to
  ...
  # SoldDevicesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sold_device" do
        sold_device = Sale.create! valid_attributes
        # Assuming there are no other sold_devices in the database, this
        # specifies that the SoldDevice created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the sold_device as @sold_device" do
        sold_device = Sale.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Sale.any_instance.stub(:save).and_return(false)
