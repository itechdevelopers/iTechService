...
describe RepairGroupsController do
  ...
  # RepairGroup. As you add validations to RepairGroup, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # RepairGroupsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested repair_group" do
        repair_group = RepairGroup.create! valid_attributes
        # Assuming there are no other repair_groups in the database, this
        # specifies that the RepairGroup created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the repair_group as @repair_group" do
        repair_group = RepairGroup.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        RepairGroup.any_instance.stub(:save).and_return(false)
