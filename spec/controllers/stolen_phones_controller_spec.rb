...
describe StolenPhonesController do
  ...
  # StolenPhone. As you add validations to StolenPhone, be sure to
  ...
  # StolenPhonesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stolen_phone" do
        stolen_phone = StolenPhone.create! valid_attributes
        # Assuming there are no other stolen_phones in the database, this
        # specifies that the StolenPhone created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the stolen_phone as @stolen_phone" do
        stolen_phone = StolenPhone.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        StolenPhone.any_instance.stub(:save).and_return(false)
