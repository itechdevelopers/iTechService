...
RSpec.describe MediaOrdersController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # MediaOrder. As you add validations to MediaOrder, be sure to
  ...
  # MediaOrdersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
