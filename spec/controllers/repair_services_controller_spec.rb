...
describe RepairServicesController do
  ...
  # RepairService. As you add validations to RepairService, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "repair_group" => "" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # RepairServicesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested repair_service" do
        repair_service = RepairService.create! valid_attributes
        # Assuming there are no other repair_services in the database, this
        # specifies that the RepairService created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the repair_service as @repair_service" do
        repair_service = RepairService.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        RepairService.any_instance.stub(:save).and_return(false)
