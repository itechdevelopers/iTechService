...
describe TimesheetDaysController do
  ...
  # TimesheetDay. As you add validations to TimesheetDay, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "date" => "2013-07-01" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # TimesheetDaysController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested timesheet_day" do
        timesheet_day = TimesheetDay.create! valid_attributes
        # Assuming there are no other timesheet_days in the database, this
        # specifies that the TimesheetDay created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the timesheet_day as @timesheet_day" do
        timesheet_day = TimesheetDay.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        TimesheetDay.any_instance.stub(:save).and_return(false)
